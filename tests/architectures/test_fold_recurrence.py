...
from conftest import encode_array, decode_term, assert_reduce_ok, make_graph_with_stdlib, build_schema
...
class TestRNN:
    ...
    def test_rnn_step_validate_fold_spec(self, real_sr, hidden):
        ...
        FoldSpec("rnn_v", "fold_step_v", None, hidden, hidden).validate(ebn, build_schema(ebn))
    ...
    def test_rnn_step_validate_unfold_spec(self, real_sr, hidden):
        ...
        UnfoldSpec("rnn_echo_v", "unfold_step_v", 3, hidden, hidden).validate(ebn, build_schema(ebn))
