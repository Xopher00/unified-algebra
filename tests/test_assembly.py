"""Assembly tests: sort junction validation, DAG wiring, rank checking, and graph execution.

Covers validate_pipeline() sort/semiring enforcement, topo_edges() DAG resolution,
rank checking across equation junctions, and assemble_graph integration.
"""
